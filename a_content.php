<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container">
        <a class="navbar-brand" href="#"> <img src="Assets/Logo Navbar.png" alt="" width="115" height="50" /> </a>
          ...
          <div class="d-flex flex-wrap align-items-center justify-content-start">
            ...
            <div class="flex-shrink-0 dropdown">
              <a href="#" class="d-block link-dark text-decoration-none dropdown-toggle" id="dropdownUser2" data-bs-toggle="dropdown" aria-expanded="false">
                <img src="Assets/Open Eye1.jpg" alt="profile pic" width="32" height="32" class="rounded-circle" />
              </a>
    ...
    <div class="container col-xl-10 px-4 py-5">
      <div class="row align-items-center g-5 py-5">
        ...
        <div class="col-lg-6">
          <img src="Assets/Hero Image.png" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy" />
        </div>
      </div>
    </div>
    ...
    <section id="deals">
      <div class="container px-4 pb-5">
        ...
        <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
          <div class="col">
            <div class="card-deals card-cover h-100 overflow-hidden text-white text-end rounded-3 shadow-lg" style="background-image: url('Assets/Thermo.png')">
          ...
          <div class="col">
            <div class="card-deals card-cover h-100 overflow-hidden text-white text-end rounded-3 shadow-lg" style="background-image: url('Assets/condom_PNG43\ 1.png'); background-size: 340px">
              <div class="d-flex flex-column h-100 pb-3 text-white text-shadow-1">
          ...
          <div class="col">
            <div class="card-deals card-cover h-100 overflow-hidden text-white text-end rounded-3 shadow-lg" style="background-image: url('Assets/toppng\ 1.png'); background-size: 340px">
              <div class="d-flex flex-column h-100 pb-3 text-white text-shadow-1">
                <div class="justify-content-md-end">
        ...
        <div class="row">
          <div class="col-md-4 col-lg-3 mb-3">
            <div class="card mt-5" style="width: auto">
              <img src="Assets/Mask Group.png" class="card-img-top" alt="..." />
          ...
          <div class="col-md-4 col-lg-3 mb-3">
            <div class="card mt-5" style="width: auto">
              <img src="Assets/Nycotine.png" class="card-img-top" alt="..." />
              <div class="card-body border-top">
          ...
          <div class="col-md-4 col-lg-3 mb-3">
            <div class="card mt-5" style="width: auto">
              <img src="Assets/Fitness.jpg" class="card-img-top" alt="..." />
              <div class="card-body border-top">
                <h5 class="card-title">Omron Arm Blood Pressure</h5>
          ...
          <div class="col-md-4 col-lg-3 mb-3">
            <div class="card mt-5" style="width: auto">
              <img src="Assets/Nerve.png" class="card-img-top" alt="..." />
              <div class="card-body border-top">
